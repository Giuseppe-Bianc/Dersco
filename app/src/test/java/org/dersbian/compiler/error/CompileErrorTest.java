...
class CompileErrorTest {
  ...
  void lexerErrorCarriesStructuredDataAndFormatsLikeRust() {
    final Span span = Span.create(SourceLocation.create(1, 1, 0L), SourceLocation.create(1, 6, 5L));
    ...
    Assertions.assertAll(
        ...
        () ->
            Assertions.assertEquals(
                "[E0001] Invalid token at 1:1-6\nhelp: Check the input", error.toString()));
  }
  ...
  void ioErrorsPreserveTheWrappedCauseAndCanFeedCompilerException() {
    ...
    Assertions.assertAll(
        ...
        () -> Assertions.assertEquals("I/O error: disk full", compilerException.getMessage()),
