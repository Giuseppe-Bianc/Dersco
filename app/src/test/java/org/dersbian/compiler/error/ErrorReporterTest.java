...
class ErrorReporterTest {
  ...
  void reportsSingleLineErrorsWithSourceContextAndHelp() {
    ...
    final Span span = Span.create(SourceLocation.create(1, 5, 4L), SourceLocation.create(1, 10, 9L));
    ...
    final String expected =
      String.join(
        "\n",
        List.of(
          "\u001B[31m\u001B[1mERROR\u001B[0m [\u001B[31m\u001B[1mE0001\u001B[0m] \u001B[31mLEX\u001B[0m: \u001B[33mInvalid token\u001B[0m",
          "\u001B[34mLocation:\u001B[0m \u001B[36m1:5-10\u001B[0m",
          "   1 │ let value = 42;",
          "     │ \u001B[31m\u001B[1m    ^^^^^\u001B[0m",
          "\u001B[34m\u001B[1mhelp:\u001B[0m \u001B[32mCheck the input\u001B[0m"));
  ...
  void reportsMultiLineErrorsAndSimpleFailures() {
    ...
    final ErrorReporter reporter = new ErrorReporter(lineTracker);
    final Span span = Span.create(SourceLocation.create(1, 3, 2L), SourceLocation.create(2, 4, 14L));
    ...
    final String expectedSyntax =
      String.join(
        "\n",
        List.of(
          "\u001B[31m\u001B[1mERROR\u001B[0m [\u001B[31m\u001B[1mE1004\u001B[0m] \u001B[31mSYNTAX\u001B[0m: \u001B[33mUnexpected token\u001B[0m",
    ...
    final String expectedAsm =
      String.join(
        "\n",
        List.of(
          "\u001B[31m\u001B[1mERROR\u001B[0m [\u001B[31m\u001B[1mE4001\u001B[0m] \u001B[31mASM GEN\u001B[0m: \u001B[33mInvalid instruction\u001B[0m",
          ""));

    Assertions.assertEquals(expectedSyntax + expectedAsm, reporter.reportErrors(List.of(syntaxError, asmError)));
  }
}