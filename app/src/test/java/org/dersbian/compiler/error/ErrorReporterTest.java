  ...
  void reportsSingleLineErrorsWithSourceContextAndHelp() {
    ...
    final String expected =
        String.join(
            "\n",
            List.of(
                "\u001B[31m\u001B[1mERROR\u001B[0m [\u001B[31m\u001B[1mE0001\u001B[0m]"
                    + " \u001B[31mLEX\u001B[0m: \u001B[33mInvalid token\u001B[0m",
  ...
  void reportsMultiLineErrorsAndSimpleFailures() {
    ...
    final String expectedSyntax =
        String.join(
            "\n",
            List.of(
                "\u001B[31m\u001B[1mERROR\u001B[0m [\u001B[31m\u001B[1mE1004\u001B[0m]"
                    + " \u001B[31mSYNTAX\u001B[0m: \u001B[33mUnexpected token\u001B[0m",
    ...
    final String expectedAsm =
        String.join(
            "\n",
            List.of(
                "\u001B[31m\u001B[1mERROR\u001B[0m [\u001B[31m\u001B[1mE4001\u001B[0m]"
                    + " \u001B[31mASM GEN\u001B[0m: \u001B[33mInvalid instruction\u001B[0m",
                ""));

    Assertions.assertEquals(
        expectedSyntax + expectedAsm, reporter.reportErrors(List.of(syntaxError, asmError)));
  }
}
