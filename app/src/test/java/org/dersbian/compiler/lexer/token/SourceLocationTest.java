    ...
    Assertions.assertAll(
        () ->
            Assertions.assertThrows(
                IllegalArgumentException.class, () -> SourceLocation.create(0, 1, 0L)),
        () ->
            Assertions.assertThrows(
                IllegalArgumentException.class, () -> SourceLocation.create(1, 0, 0L)),
        () ->
            Assertions.assertThrows(
                IllegalArgumentException.class, () -> SourceLocation.create(1, 1, -1L)),
        () ->
            Assertions.assertThrows(
                IllegalArgumentException.class,
                () -> SourceLocation.create(1, 1, 0L, 0, -2L, SourceLocation.UNKNOWN)));
  }
