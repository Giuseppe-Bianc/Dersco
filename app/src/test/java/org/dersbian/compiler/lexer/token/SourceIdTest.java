...
class SourceIdTest {
  ...
  void filePathUsesPathAsIdentifierAndDescription() {
    ...
    Assertions.assertAll(
        () -> Assertions.assertEquals(Path.of("src", "main.ds").toString(), sourceId.identifier()),
        () -> Assertions.assertEquals("file: " + Path.of("src", "main.ds"), sourceId.describe()));
  }
    ...
    Assertions.assertAll(
        () ->
            Assertions.assertThrows(
                IllegalArgumentException.class, () -> new SourceId.VirtualResource(" ")),
        () ->
            Assertions.assertThrows(
                IllegalArgumentException.class, () -> new SourceId.InMemoryModule("")),
        () ->
            Assertions.assertThrows(
                IllegalArgumentException.class, () -> new SourceId.Generated("\t")));
  }
}
