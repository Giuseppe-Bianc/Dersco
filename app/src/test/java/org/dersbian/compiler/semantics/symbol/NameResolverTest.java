...
class NameResolverTest {
    ...
    void supportsDirectFunctionRecursionButRejectsIndirectForwardReference() {
        ...
        final Stmt.Function a =
                function("a", 0, expression(new Expr.Call(recursiveReference, List.of(), SPAN)));
        final Expr.Variable forwardReference = reference("b", 10);
        final Stmt.Function b =
                function("b", 40, expression(new Expr.Call(reference("a", 60), List.of(), SPAN)));
        ...
        final NameResolutionResult result =
                new NameResolver(table)
                        .resolve(
                                List.of(
                                        expression(
                                                new Expr.Call(forwardReference, List.of(), SPAN)),
                                        a,
                                        b),
                                Mutability.IMMUTABLE);
